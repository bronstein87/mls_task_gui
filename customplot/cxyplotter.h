...
public:
    ...
    void addPoint (const double& key, const double& value, PLOT_TYPE type, qint32 seriesPos);
    ...
    QCPItemTracer* setTracer(int numberGraph, double pointX, qint32 colorIndex, bool selectable = false, QCPItemTracer::TracerStyle style = QCPItemTracer::TracerStyle::tsSquare);

    QCPItemTracer* setTracer(int numberGraph, double pointX, bool selectable = false, QCPItemTracer::TracerStyle style = QCPItemTracer::TracerStyle::tsSquare, QColor color = QColor());
